      ...
      <section id="main-content">
         <section class="wrapper">
               ...
               <div class="page-breadcrumb">
                  <nav class="c_breadcrumbs">
                     <ul>
                        ...
                        <li><a href="<?php echo base_url('k/laporan') ?>">Laporan Bulanan</a></li>
                        <li class="active"><a href="<?php echo base_url('k/laporan/detail/'.$rekap['koderekap']) ?>">Verifikasi Laporan Bulanan</a></li>
                     </ul>
                  </nav>
               </div>
            </div>
            <div class="c_panel">
               ...
               <div class="c_content">
                  <a href="<?php echo base_url('k/laporan') ?>" class="btn btn-warning btn-raised rippler rippler-default btn-sm">Kembali</a>
                  <?php if($rekap['status'] >= 3 && $rekap['status'] < 6){ ?>
...
<div class="modal" id="verifikasi" tabindex="-1" role="dialog" aria-hidden="true">
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <form action="<?php echo base_url('k/laporan/tolak') ?>" method="post">
            ...
            <div class="modal-footer">
               <a href="<?php echo base_url('k/laporan/terima/'.$rekap['koderekap']) ?>" class="btn btn-success btn-raised rippler rippler-default btn-sm">Laporan Sesuai</a>
