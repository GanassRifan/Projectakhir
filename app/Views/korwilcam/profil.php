      ...
      <section id="main-content">
         <section class="wrapper">
               ...
               <div class="page-breadcrumb">
                  <nav class="c_breadcrumbs">
                     <ul>
                        ...
                        <li class="active"><a href="<?php echo base_url('k/pengguna') ?>">Pengguna Sistem</a></li>
                     </ul>
                  </nav>
               </div>
            </div>
            <div class="c_panel">
               ...
               <form method="post" action="<?php echo base_url('k/pengguna/ubah') ?>">
                  <div class="c_content">
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control input-sm" id="exampleInputEmail1" placeholder="Nomor Telepon" name="telepon" maxlength="14" minlength="10" value="<?php echo $data['telepon'] ?>" onkeypress="return event.charCode >= 48 && event.charCode <= 57" style="color: black;" required />
                     </div>
                     <div class="form-group">
