...
$daftartahun = date('Y');
$daftarkecamatan = ['Bojong','Buaran','Doro','Kajen','Kandangserang','Karanganyar','Karangdadap','Kedungwuni','Kesesi','Lebakbarang','Paninggaran','Petungkriyono','Siwalan','Sragi','Talun','Tirto','Wiradesa','Wonokerto','Wonopringgo'];
               ...
               <div class="page-breadcrumb">
                  <nav class="c_breadcrumbs">
                     <ul>
                        ...
                        <li class="active"><a href="<?php echo base_url('a/laporan') ?>">Laporan Bulanan</a></li>
                     </ul>
                  </nav>
               </div>
            </div>
            <div class="c_panel">
               <div class="c_title">
                  ...
                  <ul class="nav navbar-right panel_options">
                     <form method="post" action="<?php echo base_url('a/laporan/tampil') ?>">
                        <li>
                           <div class="row col-lg-13">
                              ...
                              <div class="col-sm-4">
                                 <select class="form-control input-sm" name="kecamatan" style="color: black;" required onchange="this.form.submit()">
                                    <?php for ($i=0; $i < count($daftarkecamatan); $i++) {?>
                                       <option <?php if($kecamatan == $daftarkecamatan[$i]){echo "selected";} ?>><?php echo $daftarkecamatan[$i] ?></option>
                                    <?php } ?>
                                 </select>
                              </div>
                           </div>
                        ...
                        foreach ($sekolah as $d) {
                           ...
                           if($d['kecamatan'] == $kecamatan){
                              ...
                              <tr>
                                 ...
                                 <td align="center">
                                    <?php if($st >= 6 || $st == 'x'){ ?>
                                       <a href="<?php echo base_url('a/laporan/detail/'.$kode) ?>" title="Klik untuk mengubah data"><i class="fa fa-edit" style="font-size: 1.5em;"></i></a>
                                    <?php } ?>
                                 </td>
                              </tr>
                           <?php } ?>
            ...
            <div class="modal-body">
               ...
               <div class="form-group">
                  ...
                  <select class="form-control input-sm" name="kecamatan" style="color: black;" required>
                     <?php for ($i=0; $i < count($daftarkecamatan) ; $i++) {?>
                        <option><?php echo $daftarkecamatan[$i] ?></option>
                     <?php } ?>
                  </select>
               </div>
               <div class="row">
